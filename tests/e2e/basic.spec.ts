...
const isBunTestRun = typeof globalThis !== 'undefined' && 'Bun' in globalThis;

if (isBunTestRun) {
  console.warn('[tests/e2e/basic.spec.ts] Ignorado em "bun test". Execute via `npx playwright test`.');
} else {
  /**
